...
public class Inproceedings extends EntryTypes {
	...
	public Inproceedings(BibTeXEntry createFrom) {
		Value val = null;
		Value strval = null;
	...
	public boolean myequals(Inproceedings toCompare) {
		if ((this.address.equals(toCompare.getAddress())) && (this.editor.equals(toCompare.getEditor()))
				...
				&& (this.series.equals(toCompare.getSeries())) && (this.booktitle.equals(toCompare.getBooktitle()))
	...
	public String generateQuery() {
		...
		String query = "select f from fields f where bibitem = 'Inproceedings' ";
		if ((this.getBibkey() != (null)) && !this.getBibkey().isEmpty()) {
